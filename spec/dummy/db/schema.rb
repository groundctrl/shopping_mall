...
ActiveRecord::Schema.define(version: 20140612034688) do
  ...
  create_table "spree_option_types_prototypes", force: true do |t|
  ...
  create_table "spree_option_values_variants", force: true do |t|
    t.integer "variant_id"
  ...
  create_table "spree_orders_promotions", force: true do |t|
    t.integer "order_id"
  ...
  create_table "spree_roles_users", force: true do |t|
    t.integer "role_id"
    t.integer "user_id"
  end
  ...
  create_table "spree_shipping_methods_zones", force: true do |t|
    t.integer "shipping_method_id"
    t.integer "zone_id"
  end
